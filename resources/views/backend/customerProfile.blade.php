                    ...
                    <div class="doctor-widget">
                        <div class="doc-info-left">
                            ...
                            <div class="doc-info-cont">
                                ...
                                <div>
                                    @if($worker->balance<=0)
                                        <span>Balance:Ksh <b><span style="font-size:20px;color: green">{{$worker->balance}}</span></b></span>

                                    @else
                                        <span>Balance:Ksh <b><span style="font-size:20px;color: red">{{$worker->balance}}</span></b></span>
                        ...
                        <div class="doc-info-right">
                            <div class="clini-infos">
                                <ul>
                                    ...
                                    <li><i class="fas fa-map-marker-alt"></i>{{$worker->location}}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body pt-0">
                    ...
                    <nav class="user-tabs mb-4">
                        <ul class="nav nav-tabs nav-tabs-bottom nav-justified">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#doc_locations" data-bs-toggle="tab">Mpesa Transactions</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#doc_business_hours" data-bs-toggle="tab">Cash Transactions</a>
                            </li>
                                            ...
                                            <div class="table-responsive">
                                                <table class="invoice-table table table-bordered">
                                                    ...
                                                    @foreach($mpesas as $mpesa)
                                                        ...
                                                        @else
                                                            <tr>
                                                                <td class="text-end">Ksh {{$mpesa->amount}}</td>
                                                                <td class="text-end">{{$mpesa->date}}</td>
                                                            </tr>
                                                        @endif
                                                    @endforeach
                                        ...
                                        <div class="table-responsive">
                                            <table class="invoice-table table table-bordered">
                                                ...
                                                @foreach($cashs as $cash)
                                                    ...
                                                    @else
                                                        <tr>
                                                            <td class="text-end">Ksh {{$cash->amount}}</td>
                                                            <td class="text-end">{{$cash->date}}</td>
                                                        </tr>
                                                    @endif
